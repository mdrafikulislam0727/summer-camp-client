        ...
        <Carousel>
            <div className='relative'>
                ...
                <div className='absolute top-72 ml-5 '>
                    ...
                    <button className=" font-medium  transition duration-200  shadow-md  md:mb-0  px-4 py-2 md:px-8 md:py-3 m-2 text-lg rounded-full border-transparent border-2  text-gray-700 hover:bg-cyan-400 bg-cyan-200 mt-6">button</button>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='absolute top-80 ml-5 '>
                    ...
                    <button className="mt-6 font-medium  transition duration-200  shadow-md  md:mb-0  px-4 py-2 md:px-8 md:py-3 m-2 text-lg rounded-full border-transparent border-2  text-gray-700 hover:bg-cyan-400 bg-cyan-200">button</button>
                </div>
            </div>
