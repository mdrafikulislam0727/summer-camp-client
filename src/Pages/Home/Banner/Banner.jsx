            ...
            <Carousel>
                <div className='relative'>
                    ...
                    <div className='absolute top-96 ml-5 '>
                        <p className='w-96 font-bold text-2xl text-teal-500 bg-black bg-opacity-30'>Sports means all forms of physical activity which, through casual or organised participation, aim at expressing or improving physical fitness and mental wellbeing, forming social relationships or obtaining results in competition at all levels.</p>
